...
wheatprices <- read.csv(text=getURL
("https://raw.githubusercontent.com/erichseamon/seamon_dissertation/master/data/wheatprices/wheat_prices_1989_2015.csv"), 
header = FALSE, strip.white = TRUE, sep = "|")
