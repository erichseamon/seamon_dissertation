...
\newpage
```{r message=FALSE, warning=FALSE, error=TRUE, echo = FALSE, fig.width = 8, fig.height = 8, fig.cap=paste("Pacific Northwest agricultural insurance loss by damage cause - distribution by year: 2001 to 2015")}
...
means <- aggregate(loss ~  damagecause, palouse_sumloss_1989_2015_loss4, mean)
means <- means[order(means$loss),]
means <- subset(means, loss > 1000000)
means$commodity <- factor(means$damagecause)

palouse_sumloss_1989_2015_loss4 <- palouse_sumloss_1989_2015_loss4[palouse_sumloss_1989_2015_loss4$damagecause %in% means$damagecause, ]
palouse_sumloss_1989_2015_loss4$damagecause <- factor(palouse_sumloss_1989_2015_loss4$damagecause)

boxplot(palouse_sumloss_1989_2015_loss4$loss ~ palouse_sumloss_1989_2015_loss4$damagecause, col = 'lightblue', ylab = "Insurance Claim Loss ($)",  yaxt = 'n', xlab = "", names.arg = palouse_sumloss_1989_2015_loss4$damagecause, las = 3, cex.lab = 1, cex.axis = 1, cex.names = 1, font.lab = 1, font.axis = 1)
...
pts <- pretty(palouse_sumloss_1989_2015_loss4$loss / 1000000)
pts2 <- pretty(palouse_sumloss_1989_2015_loss4$loss)
axis(2, las = 1, cex.axis = 1.2, at = pts2, labels = paste(pts, "M", sep = ""))

#stripchart(palouse_sumloss_1989_2015_loss4$loss ~ palouse_sumloss_1989_2015_loss4$damagecause, vertical = TRUE,  
#    method = "jitter", add = TRUE, pch = 20, col = "blue" )


makered1 <- palouse_sumloss_1989_2015_loss4$state == "OR"
stripchart(loss ~ damagecause, method = "jitter", vertical = TRUE,  
    add = TRUE, pch = 20, col="blue", data=palouse_sumloss_1989_2015_loss4[makered1, ])

makered3 <- palouse_sumloss_1989_2015_loss4$state == "WA"
stripchart(loss ~ damagecause, method = "jitter", vertical = TRUE,  
    add = TRUE, pch = 20, col="red", data=palouse_sumloss_1989_2015_loss4[makered3, ])

makered2 <- palouse_sumloss_1989_2015_loss4$state == "ID"
stripchart(loss ~ damagecause, method = "jitter", vertical = TRUE,  
    add = TRUE, pch = 20, col="black", data=palouse_sumloss_1989_2015_loss4[makered2, ])
...
```{r message=FALSE, warning=FALSE, error=TRUE, echo = FALSE, fig.width = 8, fig.height = 8, fig.cap=paste("Pacific Northwest agricultural insurance loss claim counts by damage cause - distribution by year: 2001 to 2015")}
...
\newpage
```{r message=FALSE, warning=FALSE, error=TRUE, echo = FALSE, fig.width = 8, fig.height = 8, fig.cap=paste("Pacific Northwest agricultural insurance loss by commodity - distribution by year: 2001 to 2015")}


#par(mar=c(8, 6.1, 4, 2.1), family = 'serif', mgp=c(4, 1, 0), las=0)
par(mar=c(11, 6.1, 7, 0), cex.lab=3, family = 'serif', mgp=c(4, 1, 0), las=0)
...
```{r message=FALSE, warning=FALSE, error=TRUE, echo = FALSE, fig.width = 8.5, fig.height = 8, fig.cap=paste("Pacific Northwest agricultural insurance loss claim counts by commodity - distribution by year: 2001 to 2015")}
...
graphics::title(main="PNW insurance claim counts by commodity: 2001 to 2015", line = 1, adj = 0, cex.main = 1)
legend("topleft", inset=.02, title="State Per Year",
   c("Washington", "Idaho", "Oregon"), fill=c("red", "black", "blue"), horiz=TRUE, cex=0.8)
...
\newpage
```{r message=FALSE, warning=FALSE, error=TRUE, echo = FALSE, fig.width = 8, fig.height = 8, fig.cap=paste("Pacific Northwest agricultural insurance loss per acre by commodity - distribution by year: 2001 to 2015")}
...
boxplot(palouse_sumloss_1989_2015_loss3$loss ~ palouse_sumloss_1989_2015_loss3$commodity, col = 'lightblue', ylab = "Insurance Claim Loss ($)", yaxt = 'n', xlab = "", names.arg = palouse_sumloss_1989_2015_loss3$commodity, las = 3, cex.axis = 1, cex.main = 1, cex.lab = 1, cex.names = 1, font.lab = 1, font.axis = 1, outline = TRUE, range = 0)
#axis(2, las = 1, cex.axis = 1.2, at = pretty(palouse_sumloss_1989_2015_loss3$loss), labels = pretty(palouse_sumloss_1989_2015_loss3$loss))
...
with(subset(palouse_sumloss_1989_2015_loss3, year == 2009 & commodity == "Wheat"), text(5,257000000, labels = year, adj = c(-.3,1), cex = .9))
with(subset(palouse_sumloss_1989_2015_loss3, year == 2015 & commodity == "Wheat"), text(5,134000000, labels = year, adj = c(-.5,1), cex = .9))
...
boxplot(palouse_sumloss_1989_2015_loss4$loss ~ palouse_sumloss_1989_2015_loss4$damagecause, col = 'lightblue', ylab = "Insurance Claim Loss ($)",  yaxt = 'n', xlab = "", names.arg = palouse_sumloss_1989_2015_loss4$damagecause, las = 3, cex.lab = 1, cex.axis = 1, cex.names = 1, font.lab = 1, font.axis = 1, , outline = TRUE, range = 0)
#axis(2, las = 1, cex.axis = 1.2, at = pretty(palouse_sumloss_1989_2015_loss2$loss), labels = pretty(palouse_sumloss_1989_2015_loss2$loss))
pts <- pretty(palouse_sumloss_1989_2015_loss4$loss / 1000000)
pts2 <- pretty(palouse_sumloss_1989_2015_loss4$loss)
axis(2, las = 1, cex.axis = 1.2, at = pts2, labels = paste(pts, "M", sep = ""))
...
means <- aggregate(lossperacres ~  damagecause, palouse_sumloss_1989_2015_lossperacres3, mean)
means <- means[order(means$lossperacres),]
#means <- subset(means, loss > 1000000)
means$commodity <- factor(means$damagecause)

palouse_sumloss_1989_2015_lossperacres3 <- palouse_sumloss_1989_2015_lossperacres3[palouse_sumloss_1989_2015_lossperacres3$damagecause %in% means$damagecause, ]
palouse_sumloss_1989_2015_lossperacres3$damagecause <- factor(palouse_sumloss_1989_2015_lossperacres3$damagecause)

palouse_sumloss_1989_2015_lossperacres3$damagecause <- factor(palouse_sumloss_1989_2015_lossperacres3$damagecause)
levels(palouse_sumloss_1989_2015_lossperacres3$damagecause)[19] <- "Hurricanes/Trop Dep"
levels(palouse_sumloss_1989_2015_lossperacres3$damagecause)[30] <- "No Prep for Irr"

boxplot(palouse_sumloss_1989_2015_lossperacres3$lossperacres ~ palouse_sumloss_1989_2015_lossperacres3$damagecause, col = 'lightblue', ylab = "Insurance Caim Loss per Acre ($)",  yaxt = 'n', xlab = "", names.arg = palouse_sumloss_1989_2015_lossperacres3$damagecause, las = 3, cex.main = 1, cex.lab = 1, cex.axis = 1, cex.names = 1, font.lab = 1, font.axis = 1, outline = FALSE)
axis(2, las = 1, cex.axis = 1.4, at = pretty(palouse_sumloss_1989_2015_lossperacres3$lossperacres), labels = pretty(palouse_sumloss_1989_2015_lossperacres3$lossperacres))

graphics::title(xlab="Damage Cause", line=9.5, cex.lab = 1)
graphics::title(main="PNW insurance loss per acre by damage cause: 2001 to 2015", line = 1, adj = 0, cex.main = 1)

#stripchart(palouse_sumloss_1989_2015_lossperacres3$loss ~ palouse_sumloss_1989_2015_lossperacres3$damagecause, vertical = TRUE,  
#    method = "jitter", add = TRUE, pch = 20, col = "blue" )


makered <- palouse_sumloss_1989_2015_lossperacres3$state == "WA"
stripchart(lossperacres ~ damagecause, data=palouse_sumloss_1989_2015_lossperacres3[makered, ], method = "jitter", vertical = TRUE,  add = TRUE, pch = 20, col="red")

makered <- palouse_sumloss_1989_2015_lossperacres3$state == "ID"
stripchart(lossperacres ~ damagecause, method = "jitter", vertical = TRUE,  
    add = TRUE, pch = 20, col="black", data=palouse_sumloss_1989_2015_lossperacres3[makered, ])

makered <- palouse_sumloss_1989_2015_lossperacres3$state == "OR"
stripchart(lossperacres ~ damagecause, method = "jitter", vertical = TRUE,  
    add = TRUE, pch = 20, col="blue", data=palouse_sumloss_1989_2015_lossperacres3[makered, ])
legend("topleft", inset=.02, title="State Per Year",
   c("Washington", "Idaho", "Oregon"), fill=c("red", "black", "blue"), horiz=TRUE, cex=0.8)
