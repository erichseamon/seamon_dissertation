...
```{r message=FALSE, warning=FALSE, error=TRUE, echo = FALSE, fig.width = 7, fig.height = 5, fig.cap=paste("Pacific Northwest study area, which includes agricultural regions for the inland Pacific Northwest, the southern Idaho valley, and the Willamette valley.")}
...
```{r message=FALSE, warning=FALSE, echo= FALSE, error=TRUE, fig.width = 8, fig.height = 8, fig.cap=paste("Top panel: insurance loss for the entire PNW, for wheat by year, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used.")}
