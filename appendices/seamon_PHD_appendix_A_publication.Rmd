---
title: 'AJAE appendix A for: Agricultural Insurance Loss and Relationships to Climate across the Inland Pacific Northwest Region of the United States'
...
Appendix A documents the agricultural insurance loss exploratory data analysis process, examining the relationships of agricultural commodity loss, at a county level, from 1989-2015, across the three state region of the Pacific Northwest (Washington, Idaho, and Oregon).  We then focus in on the 24 county region of the Inland Pacific Northwest (IPNW). 
...
**1. Data Preparation.**  Here we outline the approach to load agricultural insurance loss data from Github, and preparing it for PCA analysis.  We also provide tables of the original insurance loss dataset, as well as an table of aggregated insurance loss values by county, year, commodity, and damage cause.
<br></br>
...
In order to generate any of the following tables and graphs, we download all data locally to your /tmp/seamon directory, from the seamon_dissertation_dataload.R file from the following location:
...
knitr::kable(RMA_PNW[1:10,], format="markdown", caption = "This is the table caption") %>%
...
knitr::kable(RMA_damage_PNW[1:10,], format="markdown", caption = "This is the table caption") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```

\newpage

```{r message=FALSE, warning=FALSE, error=TRUE, echo = FALSE, fig.width = 8, fig.height = 6, fig.cap=paste("Pacific Northwest study area, which includes agricultural regions for the inland Pacific Northwest, the southern Idaho valley, and the Willamette valley.")}
...
par(mar=c(14, 8.1, 7, 0), family = 'serif', mgp=c(4, 1, 0), las=0)
...
mtext("Year", cex = 1.9, side=1, line=8)
...
palouse_sumloss_1989_2015_dc <- aggregate(RMA_PNW$loss, list(RMA_PNW$damagecause), FUN = "sum")

palouse_sumloss_1989_2015_c <- aggregate(RMA_PNW$loss, list(RMA_PNW$commodity), FUN = "sum")
...
par(mar=c(18, 7.5, 6, 2.1), family = 'serif', mgp=c(7, 1, 0), las=0)
...
mtext("Commodity", cex = 1.9, side=1, line=15)
...
```{r message=FALSE, warning=TRUE, echo = FALSE, error=TRUE, fig.width = 10, fig.height = 9, fig.show='hold'}
...
palouse_sumloss_1989_2015_count2 <- aggregate(RMA_PNW$loss, list( RMA_PNW$year, RMA_PNW$damagecause), FUN = "length")
...
palouse_sumloss_1989_2015_loss_barplot <- aggregate(RMA_PNW$loss, by = list(RMA_PNW$commodity), FUN = "sum")
...
gg1 <- ggplot(palouse_sumloss_1989_2015_loss_barplot, aes(fill=region, y=loss, x=commodity)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("PNW vs IPNW loss vs. commodity: 2001 to 2015") + theme(axis.title.y = element_text(size=24), axis.title.x = element_text(size = 24), axis.text.x = element_text(size=rel(2.3), angle = 90, hjust = 1), axis.text.y = element_text(size=rel(2.3), hjust = 1)) + theme(plot.title = element_text(vjust = 2))  + theme(legend.text=element_text(size=24)) + theme(legend.title=element_text(size=24, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(labels = paste(pts, "M", sep = ""), breaks = pts * 1000000 ) + ylab("Insurance Claim Loss ($)") + theme(legend.position="bottom") + scale_fill_manual("legend", values = c("PNW minus IPNW" = "red", "IPNW" = "blue")) 
...
```{r message=FALSE, warning=FALSE, echo = FALSE, error=TRUE, fig.width = 10, fig.height = 9}
...
```{r message=FALSE, warning=FALSE, echo = FALSE, error=TRUE,  fig.width = 10, fig.height = 7}
...
gg2 <- ggplot(APPLES_damage_top, aes(fill=damagecause, y=loss, x=year)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("IPNW apples loss vs. year - top damage causes") + theme(axis.title.y = element_text(size=24), axis.title.x = element_text(size = 24), axis.text.y = element_text(size=rel(2.5), hjust = 1), axis.text.x = element_text(size=rel(2.5), angle = 90, hjust = 1)) + theme(plot.title = element_text(size =28))  +  scale_x_discrete(name = "Years", limits=c(2001:2015)) + theme(legend.text=element_text(size=14)) + scale_fill_manual("legend", values = c("Hail" = "red", "Frost" = "blue", "Freeze" = "gray")) + theme(legend.title=element_text(size=16, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(name = "Insurance claim loss ($)", label = unit_format(unit = "M", scale = 1e-6, digits = 0)) + theme(legend.position="bottom")
...
gg3 <- ggplot(apples_hailfrostfreeze_count2006, aes(fill=damagecause, y=count, x=county)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("2006 IPNW apples counts vs. county: Hail/Frost/Freeze") + theme(axis.title.y = element_text(size=16), axis.title.x = element_text(size = 16), axis.text.x = element_text(size=rel(2), angle = 90, hjust = 1), axis.text.y = element_text(size=rel(2))) + theme(plot.title = element_text(size =28))  + theme(legend.text=element_text(size=14)) + scale_fill_manual("legend", values = c("Hail" = "red", "Frost" = "blue", "Freeze" = "gray")) + theme(legend.title=element_text(size=16, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) +  theme(legend.position="bottom") + scale_y_discrete(limits=c(1:10))
...
BARLEY <- subset(RMA_damage_IPNW, commodity == "BARLEY")
...
levels(BARLEY$damagecause)[10] <- "Excessive Moisture"
...
ggplot(BARLEY_damage_top, aes(fill=damagecause, y=loss, x=year)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("IPNW barley loss vs. year - top damage causes") + theme(axis.title.y = element_text(size=16), axis.title.x = element_text(size = 16), axis.text.x = element_text(size=rel(1.5), angle = 90, hjust = 1)) + theme(plot.title = element_text(size =28))  +  scale_x_discrete(name = "Years", limits=c(2001:2015)) + theme(legend.text=element_text(size=14)) + scale_fill_manual("legend", values = c("Drought" = "red", "Heat" = "blue", "Excessive Moisture" = "gray")) + theme(legend.title=element_text(size=16, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(name = "Insurance claim loss ($)", label = unit_format(unit = "M", scale = 1e-6, digits = 0)) + theme(legend.position="bottom")
...
WHEAT <- subset(RMA_damage_IPNW, commodity == "WHEAT")
...
wheatprice <- read.csv("/tmp/seamon/wheatprice.csv", header=TRUE, strip.white =TRUE)
colnames(wheatprice) <- c("ID", "year", "month","price")
wheatprice_all <- subset(wheatprice, year >= 2001 & year <= 2015)

cpi <- data.frame(read.csv("/tmp/seamon/CPI/CPI.csv", header = TRUE, strip.white = TRUE))
cpi <- subset(cpi, year >= 2001 & year <= 2015)



wheatprice_all$price_adjusted <- wheatprice_all$price * cpi$ratio
wheatprice_all <- wheatprice_all[-1]
...
wheatproduction <- read.csv("/tmp/seamon/wheatproduction.csv", header=TRUE, strip.white =TRUE)
#colnames(wheatprice) <- c("Year", "Month","Value")

ggplot(wheatproduction, aes(fill=State, y=Value, x=Year)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("PNW Wheat production, 2001 to 2015 ") + theme(axis.title.y = element_text(size=16), axis.title.x = element_text(size = 16), axis.text.x = element_text(size=rel(1.9), angle = 90, hjust = 1), axis.text.y = element_text(size=rel(1.5))) + theme(plot.title = element_text(size =28))  +  scale_x_discrete(name = "Years", limits=c(2001:2015)) + theme(legend.text=element_text(size=14))  + theme(legend.title=element_text(size=16, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(name = "Wheat production ($)", label = unit_format(unit = "M", scale = 1e-6, digits = 0)) + theme(legend.position="bottom") + scale_fill_manual("legend", values = c("IDAHO" = "gray", "OREGON" = "blue", "WASHINGTON" = "red"))
...
#--interaction plot loss vs year for all damage causes, all Palouse counties
levels(WHEAT$damagecause)[10] <- "Excessive Moisture"
...
WHEAT_damage_droughtheat2009 <- subset(WHEAT_damage_droughtheat, year == 2009)
WHEAT_damage_droughtheat2011 <- subset(WHEAT_damage_droughtheat, year == 2011)
WHEAT_damage_droughtheat2015 <- subset(WHEAT_damage_droughtheat, year == 2015)
...
WA_wheat_yields <- read.csv("/tmp/seamon/wheatyields/Washington_yields_winterwheat.csv", header = TRUE)
...
ID_wheat_yields <- read.csv("/tmp/seamon/wheatyields/Idaho_yields_winterwheat.csv", header = TRUE)
...
OR_wheat_yields <- read.csv("/tmp/seamon/wheatyields/Oregon_yields_winterwheat.csv", header = TRUE)
...
ggplot(WHEAT_damage_top, aes(fill=damagecause, y=loss, x=year)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("IPNW wheat loss vs. year - top damage causes") + theme(axis.title.y = element_text(size=16), axis.title.x = element_text(size = 16), axis.text.x = element_text(size=rel(1.5), angle = 90, hjust = 1)) + theme(plot.title = element_text(size =28))  +  scale_x_discrete(name = "Years", limits=c(2001:2015)) + theme(legend.text=element_text(size=14)) + scale_fill_manual("legend", values = c("Drought" = "red", "Heat" = "blue", "Excessive Moisture" = "gray")) + theme(legend.title=element_text(size=16, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(name = "Insurance claim loss ($)", label = unit_format(unit = "M", scale = 1e-6, digits = 0)) + theme(legend.position="bottom")
...
ggplot(WHEAT_damage_top_decline, aes(fill=damagecause, y=loss, x=year)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("IPNW wheat loss vs. year - top damage causes + Decline in Price") + theme(axis.title.y = element_text(size=16), axis.title.x = element_text(size = 16), axis.text.x = element_text(size=rel(1.5), angle = 90, hjust = 1)) + theme(plot.title = element_text(size =28))  +  scale_x_discrete(name = "Years", limits=c(2001:2015)) + theme(legend.text=element_text(size=14)) + scale_fill_manual("legend", values = c("Drought" = "red", "Heat" = "blue", "Decline in Price" = "gray")) + theme(legend.title=element_text(size=16, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(name = "Insurance claim loss ($)", label = unit_format(unit = "M", scale = 1e-6, digits = 0)) + theme(legend.position="bottom")
...
ggplot(WHEAT_damage_top_decline_moisture) + 
    geom_bar( aes(fill=damagecause, y=loss, x=year), stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("IPNW wheat loss top damage causes \nvs. wheat production") + theme(axis.title.y = element_text(size=24), axis.title.x = element_text(size = 24), axis.text.x = element_text(size=rel(2.5), angle = 90, hjust = 1), axis.text.y = element_text(size=rel(2.5), hjust = 1)) + theme(plot.title = element_text(size =28))  +  scale_x_discrete(name = "Years", limits=c(2001:2015)) + theme(legend.text=element_text(size=14)) + scale_fill_manual("legend", values = c("Drought" = "red", "Heat" = "darkred", "Excessive Moisture" = "blue", "Decline in Price" = "gray")) + theme(legend.title=element_text(size=24, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(name = "Insurance claim loss ($)", label = unit_format(unit = "M", scale = 1e-6, digits = 0)) + theme(legend.position="bottom") 
...
RMA_damage_IPNW$log10_loss <- log10(RMA_damage_IPNW$loss)

palouse_sumloss_aggregate_wheat2 <- subset(RMA_damage_IPNW, commodity == "WHEAT")
...
levels(palouse_sumloss_aggregate_wheat2$damagecause)[10] <- "Excessive Moisture"
levels(palouse_sumloss_aggregate_wheat2$damagecause)[26] <- "Snow/Lighning"
...
palouse_sumloss_aggregate_wheat2$county <- factor(palouse_sumloss_aggregate_wheat2$county)
...
palouse_sumloss_aggregate_wheat <- subset(RMA_damage_IPNW, commodity == "WHEAT")

palouse_sumloss_1989_2015_count <- aggregate(palouse_sumloss_aggregate_wheat$count, list( palouse_sumloss_aggregate_wheat$year, palouse_sumloss_aggregate_wheat$damagecause, palouse_sumloss_aggregate_wheat$county, palouse_sumloss_aggregate_wheat$state), FUN = "sum")
...
colnames(palouse_sumloss_1989_2015_count) <- c("year", "damagecause", "county", "state", "count")
...
palouse_sumloss_aggregate_wheat_loss <- subset(RMA_damage_IPNW, commodity == "WHEAT")

palouse_sumloss_1989_2015_loss <- aggregate(palouse_sumloss_aggregate_wheat_loss$loss, list( palouse_sumloss_aggregate_wheat_loss$year, palouse_sumloss_aggregate_wheat_loss$damagecause, palouse_sumloss_aggregate_wheat_loss$county, palouse_sumloss_aggregate_wheat_loss$state), FUN = "sum")
...
colnames(palouse_sumloss_1989_2015_loss) <- c("year", "damagecause", "county", "state", "loss")
...
d1 <- data.frame(unique(RMA_damage_IPNW$county))
colnames(d1) <- "county"

d2 <- data.frame(unique(RMA_damage_IPNW$year))
colnames(d2) <- "year"
d2 <- d2[order(d2$year),]
d2 <- data.frame(d2)
colnames(d2) <- "year"
...
d2a <- c("ID", "ID", "ID", "ID", "ID", "OR", "OR", "OR", "OR", "OR", "OR", "OR", "WA", "WA", "WA", "WA", "WA", "WA", "WA", "WA", "WA", "WA", "WA", "WA")

d2a <- data.frame(d2a)
colnames(d2a) <- "state"

d1 <- data.frame(d1[rep(seq_len(nrow(d1)), each=15),])
d2 <- do.call("rbind", replicate(24, d2, simplify = FALSE))
d2a <- data.frame(d2a[rep(seq_len(nrow(d2a)), each=15),])
...
addLabelOnlyMarkers(data = WHEAT_damage_droughtheat_annual_ave_map, lng = lat_long[,1], lat = lat_long[,2], label = lapply(paste(round((WHEAT_damage_droughtheat_annual_ave_map$loss / 1000000), 0), "M", sep = ""), HTML), labelOptions = labelOptions(style = list("font-family" = "serif"), noHide = TRUE, direction = 'middle', textOnly = TRUE, textsize = "18px", col = "white",  offset = c(20, 0), markerOptions(riseOnHover = TRUE)
)) 
...
CHERRIES <- subset(RMA_damage_IPNW, commodity == "CHERRIES")
...
levels(CHERRIES$damagecause)[10] <- "Excessive Moisture"
...
ggplot(CHERRIES_damage_top, aes(fill=damagecause, y=loss, x=year)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("IPNW cherries loss vs. year - top damage causes") + theme(axis.title.y = element_text(size=16), axis.title.x = element_text(size = 16), axis.text.x = element_text(size=rel(1.5), angle = 90, hjust = 1)) + theme(plot.title = element_text(size =28))  +  scale_x_discrete(name = "Years", limits=c(2001:2015)) + theme(legend.text=element_text(size=14)) + scale_fill_manual("legend", values = c("Excessive Moisture" = "red", "Frost" = "blue", "Freeze" = "gray")) + theme(legend.title=element_text(size=16, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(name = "Insurance claim loss ($)", label = unit_format(unit = "M", scale = 1e-6, digits = 0)) + theme(legend.position="bottom")
...
DRYPEAS <- subset(RMA_damage_IPNW, commodity == "DRY PEAS")
...
levels(DRYPEAS$damagecause)[10] <- "Excessive Moisture"
...
ggplot(DRYPEAS_damage_top, aes(fill=damagecause, y=loss, x=year)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("IPNW dry peas loss vs. year - top damage causes") + theme(axis.title.y = element_text(size=16), axis.title.x = element_text(size = 16), axis.text.x = element_text(size=rel(1.5), angle = 90, hjust = 1)) + theme(plot.title = element_text(size =28))  +  scale_x_discrete(name = "Years", limits=c(2001:2015)) + theme(legend.text=element_text(size=14)) + scale_fill_manual("legend", values = c("Excessive Moisture" = "gray", "Heat" = "blue", "Drought" = "red")) + theme(legend.title=element_text(size=16, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(name = "Insurance claim loss ($)", label = unit_format(unit = "M", scale = 1e-6, digits = 0)) + theme(legend.position="bottom")
...
#remove downloaded data from your /tmp/seamon workspace

unlink("/tmp/seamon", recursive=TRUE)
