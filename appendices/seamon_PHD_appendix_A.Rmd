...
states <- readShapePoly('/tmp/seamon/states_conus.shp',
                        proj4string=CRS
...
threestates <- readShapePoly('/tmp/seamon/threestate_boundary.shp', 
                                  proj4string=CRS
                                  ("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0"))
        projection = CRS("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0")
...
counties_willamette <- readShapePoly('/tmp/seamon/threestate_willamette.shp',
                     proj4string=CRS
                     ("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0"))
projection = CRS("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0")
...
counties_ID <- readShapePoly('/tmp/seamon/threestate_southernID.shp',
                     proj4string=CRS
                     ("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0"))
projection = CRS("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0")
...
counties_palouse <- readShapePoly('/tmp/seamon/threestate_palouse.shp',
                     proj4string=CRS
                     ("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0"))
projection = CRS("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0")
...
counties <- readShapePoly('/tmp/seamon/threestate_palouse.shp',
                     proj4string=CRS
                     ("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0"))
projection = CRS("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0")
...
cpi <- data.frame(read.csv("/tmp/seamon/CPI.csv", header = TRUE, strip.white = TRUE))
...
WA_wheat_yields <- read.csv("/tmp/seamon/Washington_yields_winterwheat.csv", header = TRUE)
...
ID_wheat_yields <- read.csv("/tmp/seamon/Idaho_yields_winterwheat.csv", header = TRUE)
...
OR_wheat_yields <- read.csv("/tmp/seamon/Oregon_yields_winterwheat.csv", header = TRUE)
