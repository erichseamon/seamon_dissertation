...
###Step 8. Results of ensemble seasonal loss model for all 24 counties
...
finaldat_loss <- cbind.data.frame(data5a_statecountyear, mydat_loss)
finaldat_loss_all <- cbind.data.frame(data5a_statecountyear, mydat_loss_all)
finaldat_loss_ensemble <- cbind.data.frame(data5a_statecountyear, mydat_loss_ensemble)
...
finaldat_loss_ensemble$loss <- 10^finaldat_loss_ensemble$loss
finaldat_loss_ensemble$predictions_ensemble <- 10^finaldat_loss_ensemble$predictions_ensemble

fd_loss <- aggregate(finaldat_loss_ensemble$loss, by=list(finaldat_loss_ensemble$year), FUN = "sum")
fd_pred <- aggregate(finaldat_loss_ensemble$predictions_ensemble, by=list(finaldat_loss_ensemble$year), FUN = "sum")
